                  ...
                  if(OrderStopLoss() > 0)
                     ...
                     if(riskPips > 0)
                       {
                        ...
                        Print("Rehidratado seguimiento BE a 1:1 para ticket #", OrderTicket(),
                  ...
                  else
                    {
                     Print("ATENCION: ticket #", OrderTicket(), " vivo sin StopLoss al reiniciar. ",
                           "No se puede rehidratar riesgo inicial para BE a 1:1.");
                    }
                 }
              }
           }
...
void OnTick()
  {
   // Gestion de posiciones abiertas: BE a 1:1 + trailing (nuevo) o el esquema
